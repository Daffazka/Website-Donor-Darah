...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <ol class="breadcrumb">
        <li><a href="<?= base_url()?>/home/stokdarah_admin">Form Data Tranfusi</a></li>
      </ol>
    </section>
    ...
    <div class="box box-primary" style="margin-top:30px;">
      <!-- form start -->
      <form action="<?php echo base_url(); ?>/home/input_datatranfusi" method="post" role="form">
        <div class="box-body">
          <br>
          <br>
          <div class="form-group">
              <label>Tanggal Tranfusi</label>
              <div class="date">
              <input type="date" class="form-control" id= "tgl_tranfusi" name="tgl_tranfusi">
          </div>
          <div class="form-group"> 
            <label for="nama_pasien">Nama Pendonor</label>
            <input type="text" class="form-control" id="nama_pasien" placeholder="Masukkan Nama Pendonor" name="nama_pasien">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="rumahsakit" placeholder="Masukkan Jumlah" name="rumahsakit">
          </div>
        </div>
        <!-- /.box-body -->
