...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <ol class="breadcrumb">
        <li><a href="<?= base_url();?>home/datapendonor_admin"> Data Pendonor </a></li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="box" style="margin-top:30px;">
        <div class="box-header">
          <a href="<?php echo base_url(); ?>home/tambah_datapendonor" style="float:right;">
        ...
        <div class="box-body">
          <div class="table-responsive">  
            <table id="example1" class="table table-bordered table-striped">
              ...
              foreach ($user as $a) : ?>
              <tr>
                <td><?php echo date('d - F -Y', strtotime($a->tgl_donor)); ?></td>
                <td><?php echo $a->golongandarah ?></td>
                <td><?php echo $a->nama_pendonor ?></td>
                <td>
                  <a href="<?php echo base_url(); ?>/home/edit_datapendonor/<?php echo $a->id?>">
                    <button type="button" class="btn btn-primary">Edit</button>
                  </a>
                  <a onclick="deleteConfrim('<?php echo site_url('home/delete_datapendonor/'.$a->id) ?>')"
