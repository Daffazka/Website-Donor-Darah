...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <ol class="breadcrumb">
        <li><a href="<?= base_url();?>home/stokdarah_admin"> Stok Darah </a></li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="box" style="margin-top:30px;">
        <div class="box-header">
          <a href="<?php echo base_url(); ?>home/tambah_stokdarah" style="float:right;">
        ...
        <div class="box-body">
          <div class="table-responsive">  
            <table id="example1" class="table table-bordered table-striped">
              ...
              foreach ($user as $a) : ?> 
              <tr>
                <td><?php echo $a->jenisdarah ?></td>
                <td><?php echo $a->golongandarah ?></td>
                <td><?php echo $a->resusdarah ?></td>
                <td><?php echo $a->jumlah ?></td>
                <td>
                  <a href="<?php echo base_url(); ?>/home/edit_stokdarah/<?php echo $a->id?>">
                    <button type="button" class="btn btn-primary">Edit</button>
                  </a>
                  <a onclick="deleteConfrim('<?php echo site_url('home/delete_stokdarah/'.$a->id) ?>')"
